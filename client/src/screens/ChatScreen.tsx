...
import { getChatMessages, getMatch, getThreeIcebreakers, type MatchData } from '@/services/api';
...
export default function ChatScreen(): React.JSX.Element {
  ...
  useEffect(() => {
    ...
    // Fetch 3 icebreakers for empty chats
    getThreeIcebreakers(matchId)
  ...
  return (
    <div className="flex h-screen flex-col" style={{ background: 'var(--s0)', color: 'var(--tx)' }}>
      ...
      {/* Icebreaker bubbles (show when chat is empty) */}
      {!loading && messages.length === 0 && icebreakers.length > 0 && !icebreakersDismissed && (
        <div className="mb-4 px-4">
          <div className="mb-2 flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={() => setIcebreakersDismissed(true)}
